...
<head>
  ...
  <title>Arvice Admin Panel</title>
...
<div class="wrapper" id="app"> 
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="/img/logo.png" alt="BuySellHousing Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Arvice</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017-2019 <a href="https://www.trickuweb.com">Arvice</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
