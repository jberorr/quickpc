...
use Arvice\Invitation;
use Arvice\GuestEmail;
use Illuminate\Support\Facades\Mail;
use Arvice\Mail\InvitationSentMail;
use Arvice\Mail\InvitationCancelMail;
use Arvice\Mail\MyEventMail;
use Notification;
use Session;
...
class InvitationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //  Notification::send($guest, new \Arvice\Notifications\InvitationCreated($id)); 
